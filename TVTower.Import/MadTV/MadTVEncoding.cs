...
{
	public static class MadTVEncoding
	{
		public static UTF7Encoding GetEncoding()
		{
			var result = (UTF7Encoding)new UTF7Encoding().Clone();
			result.DecoderFallback = new MadTVMapper( "~" );
			return result;
		}
	}
