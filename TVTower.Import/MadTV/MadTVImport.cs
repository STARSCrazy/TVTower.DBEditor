	...
	public class MadTVImport
	{
        ...
        public static Encoding GetMadTVEncoding()
        {
            if (encodingCache == null)
                encodingCache = new MadTVEncoding(); //(UTF7Encoding)new UTF7Encoding().Clone();
        ...
        public static void ImportMovies(string nameFilePath, int namesEntryPoint, string valuesFilePath, int valuesEntryPoint)
		{
