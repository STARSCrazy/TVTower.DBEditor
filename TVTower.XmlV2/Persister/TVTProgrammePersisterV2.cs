...
namespace TVTower.XmlV2.Persister
{
	...
	//{
		...
		//public override void Load( XmlNode xmlNode, TVTProgramme movie, ITVTDatabase database )
		//{
		...
		//        {
		//            case "data":
		//                var director = OldV2Converter.GetPersonByNameOrCreate( database, movieOldV2.director, episode.DataType, TVTPersonFunction.Director );
		//                if ( director != null )
		//                    episode.Staff.Add( new TVTStaff( director, TVTPersonFunction.Director ) );

		//                var actors = OldV2Converter.GetPersonsByNameOrCreate( database, movieChild.GetAttribute( "actors" ), TVTDataType.Fictitious, TVTPersonFunction.Actor );
		//                actors.ForEach( x => movie.Staff.Add( new TVTStaff( x, TVTPersonFunction.Actor ) ) );



		//                movie.Staff = ToPersonListByName( movieChild.GetAttribute( "actors" ), database, defaultStatus, TVTPersonFunction.Actor );
