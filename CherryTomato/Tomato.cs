...
namespace CherryTomato
{
	public class Tomato
	{
		...
		public List<TomatoMovie> FindMovieCollection(IEnumerable<int> movieIds)
		{
		...
		private const string MOVIE_BY_IMDB = @"http://api.rottentomatoes.com/api/public/v1.0/movie_alias.json?apikey={0}&type=imdb&id={1}";
